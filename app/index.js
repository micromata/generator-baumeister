    ...
    if (!this.skipPrompts) {
      ...
      const prompts = [
        ...
        },
        {
          ...
          name: 'theme',
          message:
            'How should your Bootstrap theme be named in the Sass files?',
          default: 'theme'
        },
        {
          type: 'list',
          ...
          message:
            'With how many boilerplate code you like to get started with?',
          choices: [
            {
        ...
        },
        {
          ...
          name: 'authorName',
          message:
            'What’s your Name? ' + info('(used in package.json and license)'),
          store: true
        },
        {
          type: 'input',
          ...
          message:
            ...
            info(
              '(not the projects website if they differ – used in package.json and License)'
            ),
          store: true
        },
        {
  ...
  writing() {
    ...
    this.fs.copyTpl(
      ...
      this.destinationPath(
        'src/assets/scss/_' + this.templateProps.theme + '.scss'
      ),
      {
        templateProps: this.templateProps
      }
    ...
    if (this.templateProps.boilerplateAmount === 'little') {
      this.fs.copyTpl(
        ...
        this.destinationPath(
          'src/assets/scss/' + this.templateProps.theme + '/_alerts.scss'
        ),
        {
          templateProps: this.templateProps
        }
      ...
      this.fs.copyTpl(
        ...
        this.destinationPath(
          'src/assets/scss/' + this.templateProps.theme + '/_footer.scss'
        ),
        {
          templateProps: this.templateProps
        }
      ...
      this.fs.copyTpl(
        ...
        this.destinationPath(
          'src/assets/scss/' + this.templateProps.theme + '/_mixins.scss'
        )
      );
      ...
      this.fs.copyTpl(
        ...
        this.destinationPath(
          'src/assets/scss/' + this.templateProps.theme + '/_scaffolding.scss'
        )
      );
    }
